...
<div class="navbar" style="padding-left: 20%; padding-right: 20%">
    ...
    <a class="active" href="Schedule_for.php"><i class="fa fa-list-alt"></i> Scheduled</a>
</div>
...
<body style="
    ...
    $SQL = "SELECT COUNT(`Name`) AS student, Discipline, School, Semester, Date FROM scheduled GROUP BY `school`, `Discipline`, `Semester`, `Date`;";
