          ...
          <div class="card" style="border-radius: 1rem;">
            <div class="row g-2">
              <div class="col-md-5 col-lg-5 d-none d-md-block">
                <img src="login_image.png" alt="login form" class="img-fluid" style=" width: 600px; height: 400px; margin-top: auto;margin-bottom: auto; margin-top: 25%; " />
              </div>
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form name="Login" action="login.php" onsubmit="return validate(this) " method="Post">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <label class="form-label" for="form2Example17">Admin Email address</label>
                    </div>
