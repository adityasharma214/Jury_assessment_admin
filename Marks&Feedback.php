...
<div class="navbar" style="padding-left: 20%; padding-right: 20%">
    <a href="index.php"><i class="fa fa-fw fa-calendar"></i> Schedule</a>
    <a class="active" href="Marks&Feedback.php"><i class="fa fa-file"></i> Marks/Feedback</a>
    ...
    <a href="Schedule_for.php"><i class="fa fa-list-alt"></i> Scheduled</a>
</div>
...
<body style="
    ...
    <form action="" method="Post">
        ...
        ">
            <div class="col-md">
                <div class="form-floating">
                    <select required class="form-select" id="school" name="school" aria-label="Floating label select example">
                        <option disabled>---Select the School---</option>
                ...
                <div style="padding-top: 20px">
                    <div class="form-floating">
                        <select required class="form-select" id="branch" name="branch" aria-label="Floating label select example">
                            <option disabled>---Select the Discipline---</option>
            ...
            <div class="col-md">
                <div class="form-floating">
                    <select required class="form-select" id="semester" name="semester" aria-label="Floating label select example">
        ...
        <div class="text-center" style="padding-top: 20px;">
            <button id="marks" type="submit" class="btn btn-success me-2" style="align-items: center">
                Submit
            </button>
        </div>
    </form>
    ...
    $SQL = "SELECT * FROM `marks` WHERE `School` ='$school' AND `Discipline`='$branch' AND `Semester`='$semester';";
        ...
        <table class="table table-light table-bordered border-dark">
            ...
            <tbody>
                ...
                while ($rows = $result->fetch_assoc()) {
                    $count = $count + 1;
                    $enroll = $rows['Enrollment_id'];
                    $out_off = "SELECT SUM(rubrics.`Out of`) FROM `grades` grades JOIN rubrics WHERE grades.Rubrics_id=rubrics.Rubrics_id AND Enrollment_id='$enroll';";
                    $result2 = $conn->query($out_off);
                ?>
                    <tr>
                        ...
                        <td><?php while ($rowss = $result2->fetch_assoc()) { echo $rowss['SUM(rubrics.`Out of`)']; }?></td>
